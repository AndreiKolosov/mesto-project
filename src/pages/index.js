...
.then(([userData, cardsData]) => {
  const currentUser = new User(userData, userNameSelector, userDescriptionSelector, userAvatarSelector);
  ...
  const cardList = new Section({
    ...
    renderer: (item) => {
      ...
      const card = new Card(item, cardTemplateSelector, handleLikeClick, handleDeleteClick, likedByMe);
